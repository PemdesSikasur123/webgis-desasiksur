...
<qgis version="3.42.0-Münster">
  <identifier>TANAMANKAYUBUDIDAYA</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>TANAMANKAYUBUDIDAYA</title>
  ...
  <links>
    <link type="Local Area Network" mimeType="" format="" size="" name="" url="file://\\DEMON\C$\Geodatabase_FDS.gdb" description=""/>
  </links>
  <dates/>
  <fees></fees>
  <encoding></encoding>
